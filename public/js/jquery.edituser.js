$(function(){
	$('#passwordtable').hide().click(function(event) { event.preventDefault();});
	var b = $('#changepassword'); b.click(function(){$('#passwordtable').toggle(400,'linear',function(){ if (b.text()=='Change Password') b.text('  Hide  <<'); else b.text('Change Password');passwordh();}); return false;});
	$("#firstname").validate({
