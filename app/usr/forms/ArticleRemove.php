 ...
 * -------------------------------------------
 */
class Point_Form_ArticleRemove extends Point_Form_XZendForm
{
	...
	public function init()
	{
		...
		$this->setAttribs(array('class' => 'form'	,
			...
			->setMethod('post')->setAction('/articles/removearticles');
		
		
		/*
		 * Article Remove		Button (Submit)
		...
		$hidden2  = new Zend_Form_Element_Hidden('a_id');
