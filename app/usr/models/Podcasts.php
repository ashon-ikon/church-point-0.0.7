 ...
 * Created by ashon on Apr 5, 2012
 * (c) 2010 - 2012 Copyright
 * -------------------------------------------
 */
class Point_Model_Podcasts
{
	/**
	 * Table name
	 */
	protected	$_table_name 	= 'pod_table';
	...
	/**
	 * @var	string	group keyword
	 */
	protected	$_content_group_keyword	= 'Podcast';
